...
const LOG_STATUS_STYLES: Record<string, string> = {
  queued: "bg-zinc-500/10 text-zinc-600 ring-zinc-500/20 dark:text-zinc-400",
  sending: "bg-sky-500/10 text-sky-700 ring-sky-500/20 dark:text-sky-400",
  uncertain: "bg-amber-500/10 text-amber-700 ring-amber-500/20 dark:text-amber-400",
