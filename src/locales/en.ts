...
export const en: Translations = {
  ...
  accountApiKeys: {
    ...
    "create": "New key",
    "edit": "Edit key",
    "description": "Keys remain limited by your current account access. Choose operations and an expiry within one year.",
    "name": "Name",
    "expiresAt": "Expires",
    "resources": "Resources",
    "allResources": "All resources accessible to my account",
    "selectedProducts": "Selected products",
    "permissions": "Operations",
    "readOnly": "Read-only preset",
    "selectAll": "Select all",
    "clear": "Clear",
    "search": "Search operations or endpoints",
    "empty": "No account API keys",
    "noProducts": "No products available",
    "loadFailed": "Could not load account API keys",
    ...
    "revoked": "Revoked",
    "revoke": "Revoke key",
    "revokeConfirm": "Revoke “{{name}}”? It will stop working immediately and cannot be restored.",
    "lastUsed": "Last used",
    "never": "Never",
    "secretTitle": "Key created",
    "secretWarning": "This key is shown once. Store it securely; keep it out of browser code and chat transcripts.",
    "writeWarning": "Write permissions allow changes to the selected resources. User, credential and product-key management may also grant access to other principals.",
    "validation": "Enter a name and a future expiry within one year, select operations, and select products when using selected-product scope.",
    "noExtension": "An existing key can only expire sooner. Create a replacement and revoke the old key to extend access.",
    "legacyExpiry": "Legacy key without an expiry",
    "operations": {
        "list_notification_endpoints": "List notification endpoints",
        "get_notification_endpoint": "Get notification endpoint",
        "create_notification_endpoint": "Create notification endpoint",
        "update_notification_endpoint": "Update notification endpoint",
        "delete_notification_endpoint": "Delete notification endpoint",
        "test_notification_endpoint": "Test notification endpoint",
        "test_email_config": "Test email config",
        "rotate_inbound_webhook_secret": "Rotate inbound webhook secret",
        "release_inbound_email": "Release inbound email",
        "get_spam_filter": "Get spam filter",
        "update_spam_filter": "Update spam filter",
        "list_ai_models": "List ai models",
        "delete_ai_route": "Delete ai route",
        "get_ai_usage": "Get ai usage",
        "get_ai_usage_settings": "Get ai usage settings",
        "update_ai_usage_settings": "Update ai usage settings",
        "get_knowledge_index_status": "Get knowledge index status",
        "reindex_knowledge": "Reindex knowledge",
        "list_documents": "List documents",
        "get_document": "Get document",
        "delete_document": "Delete document",
        "upload_document": "Upload document",
        "upload_ticket_image": "Upload ticket image",
        "translate_product_content": "Translate product content",

        "get_dashboard": "Get dashboard",
        "list_visible_products": "List visible products",
        "list_visible_teams": "List visible teams",
        ...
        "update_ticket_internal_state": "Update ticket internal state",
        "bulk_assign_tickets": "Bulk assign tickets",
        "bulk_update_ticket_status": "Bulk update ticket status",
        ...
        "archive_ticket_type": "Archive ticket type",
        "restore_ticket_type": "Restore ticket type",
        "get_type_route": "Get type route",
        "set_type_route": "Set type route",
        "remove_type_route": "Remove type route",
        "get_ticket_template": "Get ticket template",
        "list_template_versions": "List template versions",
        "save_template_version": "Save template version",
        "clone_template_version": "Clone template version",
        "invalidate_template_version": "Invalidate template version",
        "archive_ticket_template": "Archive ticket template",
        "restore_ticket_template": "Restore ticket template",
        "list_type_internal_states": "List type internal states",
        "create_type_internal_state": "Create type internal state",
        "update_type_internal_state": "Update type internal state",
        "archive_type_internal_state": "Archive type internal state",
        "restore_type_internal_state": "Restore type internal state",
        "list_type_presets": "List type presets",
        "create_type_preset": "Create type preset",
        "update_type_preset": "Update type preset",
        "archive_type_preset": "Archive type preset",
        "restore_type_preset": "Restore type preset",
        "apply_type_preset": "Apply type preset",
        ...
        "list_eligible_agents": "List eligible agents",
        ...
        "get_email_config": "Get email config",
        "save_email_config": "Save email config",
        "list_inbound_email_logs": "List inbound email logs",
        "list_outbound_email_logs": "List outbound email logs",
        "get_notification_compliance": "Get notification compliance",
        ...
        "list_ai_credentials": "List ai credentials",
        "create_ai_credential": "Create ai credential",
        "update_ai_credential": "Update ai credential",
        "delete_ai_credential": "Delete ai credential",
        "list_ai_routes": "List ai routes",
        "save_ai_route": "Save ai route",
        "list_product_keys": "List product keys",
        "create_product_key": "Create product key",
        "get_product_key": "Get product key",
        "update_product_key": "Update product key",
        "delete_product_key": "Delete product key",
        "rotate_product_key": "Rotate product key",
        "list_notification_rules": "List notification rules",
        "create_notification_rule": "Create notification rule",
        "update_notification_rule": "Update notification rule",
        "delete_notification_rule": "Delete notification rule",
        "list_notification_requirements": "List notification requirements",
        "create_notification_requirement": "Create notification requirement",
        "update_notification_requirement": "Update notification requirement",
        "delete_notification_requirement": "Delete notification requirement"
    }
},
  ...
  emailConfig: {
    ...
    inbound: {
      ...
      cloudflareHint: 'Cloudflare Email Routing delivers to the main Worker or a configured mail agent. No webhook secret is required.',
      stalwartHint: 'Use the MTA Hook endpoint for DATA-stage ticket intake and the Events endpoint for delivery telemetry. Both use the generated webhook secret.',
    ...
    outbound: {
      ...
      cloudflareHint: 'Uses Cloudflare Email Sending. Configured mail-agent addresses are queued for delivery. Enable the sender domain in Cloudflare first.',
      ...
      testQueued: 'Test email queued. Check delivery in the email logs.',
  ...
  notifChannels: {
    ...
    testQueued: 'Test notification queued for email delivery',
  ...
  aiConfig: {
    ...
    usage: {
      ...
      grouping: 'Group usage',
      byCredentialModel: 'Credential / model',
      dailyDetails: 'Daily details',
      deletedCredential: 'Deleted credential',
      legacyModel: 'Historical usage (model unknown)',
  ...
  management: {
    ...
    apiKeys: {
      ...
      rotate: 'Rotate',
      revoke: 'Revoke',
      description: 'Server-side keys for issuing customer portal tokens',
      create: 'New API Key',
      edit: 'Edit API Key',
      name: 'Name',
      product: 'Product',
