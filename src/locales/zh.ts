export const zh = {
  ...
  accountApiKeys: {
    ...
    "create": "新建密钥",
    "edit": "编辑密钥",
    "description": "密钥始终受你的当前账户权限限制。按操作授权，并设置到期时间（最长一年）。",
    "name": "名称",
    "expiresAt": "到期时间",
    "resources": "资源范围",
    "allResources": "账户可访问的所有资源",
    "selectedProducts": "指定产品",
    "permissions": "操作权限",
    "readOnly": "只读预设",
    "selectAll": "全选",
    "clear": "清空",
    ...
    "revoked": "已撤销",
    "revoke": "撤销密钥",
    "revokeConfirm": "撤销“{{name}}”后，该密钥立即失效且无法恢复。",
    "lastUsed": "最近使用",
    "never": "从未使用",
    "secretTitle": "密钥已创建",
    "secretWarning": "密钥仅显示一次。请安全保存，不要放入网页代码或聊天记录。",
    "writeWarning": "写入权限允许修改对应资源。用户管理、凭据和产品密钥操作还可能授予其他主体访问权限。",
    "validation": "请填写名称、未来一年内的到期时间，选择至少一项操作权限；指定产品模式下还需选择产品。",
    "noExtension": "现有密钥只能缩短有效期。如需延期，请创建新密钥并撤销旧密钥。",
    "legacyExpiry": "旧密钥未设置到期时间",
    "operations": {
        "list_notification_endpoints": "读取个人通知端点",
        "get_notification_endpoint": "读取个人通知端点详情",
        "create_notification_endpoint": "创建个人通知端点",
        "update_notification_endpoint": "修改个人通知端点",
        "delete_notification_endpoint": "删除个人通知端点",
        "test_notification_endpoint": "发送测试通知",
        "test_email_config": "发送测试邮件",
        "rotate_inbound_webhook_secret": "轮换入站邮件 Webhook 密钥",
        "release_inbound_email": "放行隔离邮件",
        "get_spam_filter": "读取垃圾过滤配置",
        "update_spam_filter": "修改垃圾过滤配置",
        "list_ai_models": "查询 AI 模型",
        "delete_ai_route": "删除 AI 任务路由",
        "get_ai_usage": "读取 AI 用量",
        "get_ai_usage_settings": "读取 AI 用量保留设置",
        "update_ai_usage_settings": "修改 AI 用量保留设置",
        "get_knowledge_index_status": "读取知识索引状态",
        "reindex_knowledge": "重建知识索引",
        "list_documents": "读取知识文档列表",
        "get_document": "读取知识文档信息",
        "delete_document": "删除知识文档",
        "upload_document": "上传知识源文档",
        "upload_ticket_image": "上传工单图片",
        "translate_product_content": "生成产品内容翻译",

        "get_dashboard": "读取仪表盘",
        "list_visible_products": "查询可访问产品",
        "list_visible_teams": "查询可访问团队",
        "list_team_agents": "查询团队客服",
        "list_tickets": "查询工单",
        "get_ticket": "读取工单详情",
        "reply_ticket": "公开回复工单",
        "add_ticket_note": "添加内部备注",
        "update_ticket_status": "更改工单状态",
        "update_ticket_priority": "更改工单优先级",
        "assign_ticket": "首次指派工单",
        "reassign_ticket": "重新指派工单",
        "escalate_ticket": "升级工单",
        "close_ticket": "关闭工单",
        "reopen_ticket": "重新打开工单",
        "update_ticket_internal_state": "更新工单内部状态",
        "bulk_assign_tickets": "批量指派及重新指派工单",
        "bulk_update_ticket_status": "批量更改工单状态",
        "bulk_close_tickets": "批量关闭工单",
        "list_products": "读取产品配置列表",
        "get_product": "读取产品配置",
        "create_product": "创建产品",
        "update_product": "修改产品配置",
        "delete_product": "删除产品",
        "list_ticket_types": "读取工单类型和表单概览",
        "create_ticket_type": "创建工单类型",
        "update_ticket_type": "修改工单类型",
        "archive_ticket_type": "归档工单类型",
        "restore_ticket_type": "恢复工单类型",
        "get_type_route": "读取类型路由",
        "set_type_route": "设置类型路由",
        "remove_type_route": "移除类型路由",
        "get_ticket_template": "读取工单表单",
        "list_template_versions": "读取表单版本",
        "save_template_version": "发布表单新版本",
        "clone_template_version": "复制历史表单版本",
        "invalidate_template_version": "使历史表单版本失效",
        "archive_ticket_template": "归档工单表单",
        "restore_ticket_template": "恢复工单表单",
        "list_type_internal_states": "读取内部状态定义",
        "create_type_internal_state": "创建内部状态定义",
        "update_type_internal_state": "修改内部状态定义",
        "archive_type_internal_state": "归档内部状态定义",
        "restore_type_internal_state": "恢复内部状态定义",
        "list_type_presets": "读取租户类型预设",
        "create_type_preset": "创建类型预设",
        "update_type_preset": "修改类型预设",
        "archive_type_preset": "归档类型预设",
        "restore_type_preset": "恢复类型预设",
        "apply_type_preset": "将预设复制到产品",
        "list_customers": "查询客户",
        "list_teams": "读取团队列表",
        "get_team": "读取团队详情",
        "create_team": "创建团队",
        ...
        "delete_team": "删除团队",
        "list_agents": "读取客服列表",
        "list_eligible_agents": "查询可加入团队的用户",
        "create_agent": "添加客服",
        "update_agent": "修改客服",
        "list_tenants": "读取租户列表",
        "get_tenant": "读取租户详情",
        ...
        "list_users": "读取用户列表",
        "get_user": "读取用户详情",
        "create_user": "创建用户及授予角色",
        "update_user": "修改用户及角色",
        "delete_user": "删除用户",
        "list_email_templates": "读取邮件模板",
        "create_email_template": "创建邮件模板",
        "update_email_template": "修改邮件模板",
        "delete_email_template": "删除邮件模板",
        "get_email_config": "读取邮件配置",
        "save_email_config": "保存邮件配置",
        "list_inbound_email_logs": "读取收件日志",
        "list_outbound_email_logs": "读取发件日志",
        "get_notification_compliance": "读取通知合规状态",
        "list_knowledge": "读取知识列表",
        "get_knowledge": "读取知识详情",
        "create_knowledge": "创建知识",
        "update_knowledge": "修改知识",
        "delete_knowledge": "删除知识",
        "list_ai_credentials": "读取 AI 凭据元数据",
        "create_ai_credential": "创建 AI 凭据",
        "update_ai_credential": "修改 AI 凭据",
        "delete_ai_credential": "删除 AI 凭据",
        "list_ai_routes": "读取 AI 任务路由",
        "save_ai_route": "保存 AI 任务路由",
        "list_product_keys": "读取产品密钥列表",
        "create_product_key": "创建产品密钥",
        "get_product_key": "读取产品密钥元数据",
        "update_product_key": "修改或撤销产品密钥",
        "delete_product_key": "删除产品密钥",
        "rotate_product_key": "轮换产品密钥",
        "list_notification_rules": "读取通知规则",
        "create_notification_rule": "创建通知规则",
        "update_notification_rule": "修改通知规则",
        "delete_notification_rule": "删除通知规则",
        "list_notification_requirements": "读取通知要求",
        "create_notification_requirement": "创建通知要求",
        "update_notification_requirement": "修改通知要求",
        "delete_notification_requirement": "删除通知要求"
    }
},
  ...
  emailConfig: {
    ...
    inbound: {
      ...
      cloudflareHint: 'Cloudflare Email Routing 可投递到主 Worker 或已配置的邮件代理，无需配置 Webhook 密钥。',
    ...
    outbound: {
      ...
      cloudflareHint: '通过 Cloudflare Email Sending 发送；已配置邮件代理的地址会排队投递。发件域名需先在 Cloudflare 中启用。',
      testSend: '发送测试邮件',
      ...
      testSent: '测试邮件已发送',
      testQueued: '测试邮件已排队，请在邮件日志中查看投递结果。',
      testFailed: '测试邮件发送失败',
